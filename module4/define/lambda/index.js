...
function sendExperienceEvent(selectedProduct, interaction) {
  ...
  experienceEventJson.body.xdmEntity.identityMap.ECID[0].id = emailAddress;
  experienceEventJson.body.xdmEntity._experienceplatform.productData.productUrl = productImage1.url();
  experienceEventJson.body.xdmEntity._experienceplatform.productData.productName = selectedProduct.get("name");
  experienceEventJson.body.xdmEntity._experienceplatform.productData.productInteraction = interaction;
  experienceEventJson.body.xdmEntity._experienceplatform.identification.emailId = emailAddress;
